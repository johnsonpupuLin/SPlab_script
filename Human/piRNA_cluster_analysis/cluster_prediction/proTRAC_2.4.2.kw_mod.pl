...
$proTRAC_version="2.4.2";
$proTRAC_date="11. May 2018";
$|=1;
...
###   CHECK OPTIONS   ###
if($threshold_density_absolute>0&&$threshold_density_pvalue){print"\nERROR: Do not use options -dens and -pdens together!\n\n";exit;}
if($threshold_density_absolute){$exp_or_obs=0;$options_info="Minimum hit density: $threshold_density_absolute hits/kb";}
...
else{$exp_or_obs=2;$options_info="Significant (p<=$threshold_density_pvalue) hit density will be calculated based\non observed hit distribution.";}
...
"
               ...
               I     pro             /    \\/      \\     I
               I        TRAC        /               \\   I
               I   ________________/_________________\\_ I
               I   \\              /                     I
               I    \\            /                      I
...
if($results_table==1)
	...
	if(-e$RMannotation) # add information on transposon content in genome/piRNA clusters to summary table
		{
